...
piusDFTest_NumClustKnown_AMI_Ver = function(treatmentDF, iStrength = 1, sigmaMax = 0.1,
                                            thresholdMult = 10 ^ (-3), maxSteps = 10 ^ 4, tStep = 10 ^ (-2),
                                            intTime = 1, interSmplMult = 0.01, returnParams = FALSE,
                                            conGraph = NULL, rollRange = 0.025, numClust = NULL,
  ...
  testInputsMat = do.call(rbind, testInputsMatList)
  ...
  performTreatmentTest = function(inputRow){
    ...
    testResult = piusTreatmentTest(M = M, numSubgroups = numSubgroups, N = N, iStrength = iStrength,
                                       ...
                                       rollRange = rollRange, numClust = numSubgroups,
...
} #  end  piusDFTest_NumClustKnown_AMI_Ver  function
