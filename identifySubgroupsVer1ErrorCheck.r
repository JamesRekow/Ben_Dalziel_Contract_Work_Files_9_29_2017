...
identifySubgroupsVer1ErrorCheck = function(MVec = NULL, NVec = NULL, lambdaVec = NULL,
  ...
  source("identifySubgroupsVer1Test.r")
  ...
  percentErrorProducer = function(inputVec){
    ...
    percentError = identifySubgroupsVer1Test(M = M, numSubgroups = numSubgroups, N = N,
...
} #  end identifySubgroupsVer1ErrorCheck function
