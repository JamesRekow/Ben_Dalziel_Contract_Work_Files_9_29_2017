...
identifySubgroupsVer1Test_Exp_Weight = function(M = 40, numSubgroups = 2, N = 20, iStrength = 1, univ = 1,
  ...
  source("identifySubgroupsVer1_Exp_Weight.r")
  ...
  subgroupsComputed = identifySubgroupsVer1_Exp_Weight(abdList = abdList, rollRange = rollRange,
                                                       numClust = numClust)
...
} #  end identifySubgroupsVer1Test_Exp_Weight function
