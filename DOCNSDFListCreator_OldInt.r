...
DOCNSDFListCreator_OldInt = function(conGraph, M = 80, N = 20, iStrength = 1, univ = 1, sigmaMax = 0.1,
  ...
  source("conSynthChrtCreator_OldInt.r")
  ...
  produceSynthDOCNSDF = function(int){
    ...
    produceConSynthChrt = function(x = NULL) conSynthChrtCreator_OldInt(synthM = synthM,
                                                                        conGraph = conGraph,
                                                                        abdList = abdList, int = int)
    
    #  create synthetic cohort
    synthChrtList = lapply(as.list(1:numSynthChrt), produceConSynthChrt)
...
} #  end DOCNSDFListCreator_OldInt function
