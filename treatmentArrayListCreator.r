...
#  switched to comparing diss instead of over, switch back if this doesn't seem promising, or add
#  this choice as a function input
...
treatmentArrayListCreator = function(M = 80, N = 20, iStrength = 1, univ = 1, sigmaMax = 0.1,
  ...
  correctMeans = function(DFList) mean(DFList[[1]]$y) > mean(DFList[[2]]$y)
