...
piusBenchmark_AMI_Ver = function(MVec = NULL, NVec = NULL, numSubgroupsVec = NULL, lambdaVec = NULL,
                          univVec = NULL, iStrength = 1, sigmaMax = 0.1, thresholdMult = 10 ^ (-3),
                          maxSteps = 10 ^ 4, tStep = 10 ^ (-2), intTime = 1, interSmplMult = 0.01,
                          returnParams = FALSE, conGraph = NULL, rollRange = 0.025, numClust = NULL,
                          numReplicates = 2, numComputeClusters = 64){
  ...
  testResultsDF = piusDFTest_AMI_Ver(treatmentDF = treatmentDF, iStrength = iStrength, sigmaMax = sigmaMax,
                                     ...
                                     numReplicates = numReplicates, numComputeClusters = numComputeClusters)
  
  return(testResultsDF)
  
} #  end  piusBenchmark_AMI_Ver  function
