...
identifySubgroupsVer1Test = function(M = 40, numSubgroups = 2, N = 20, iStrength = 1, univ = 1,
  ...
  source("identifySubgroupsVer1.r")
  ...
  subgroupsComputed = identifySubgroupsVer1(abdList = abdList, rollRange = rollRange, numClust = numClust)
...
} #  end identifySubgroupsVer1Test function
