...
identifyNumSubgroups2Test = function(MVec = NULL, NVec = NULL, lambdaVec = NULL, numSubgroupsVec = NULL,
  ...
  source("identifyNumSubgroups2.r")
  ...
  correctNumberIdentified = function(inputVec){
    ...
    numSubgroupsGuess = identifyNumSubgroups2(infoMat = infoWeightMat, centersVec = 1:10)
...
} #  end identifyNumSubgroups2Test function
