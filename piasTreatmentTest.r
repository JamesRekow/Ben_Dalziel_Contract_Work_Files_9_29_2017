...
piasTreatmentTest  = function(M = 40, numSubgroups = 1, N = 20, iStrength = 1, univ = 1,
  ...
  subgroupsComputed = pias(abdList, rollRange = rollRange, numClust = numClust)
...
} #  end  piasTreatmentTest  function
